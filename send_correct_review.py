#!/usr/bin/env python3
"""
使用正确数组格式发送ACP Bridge review给Gemini CLI
"""
                ...
                while True:
                    ...
                    try:
                        ...
                        if "method" in response and response["method"] == "session/update":
                            ...
                            print("=" * 80)
                            print("🤖 Gemini CLI的ACP Bridge Review反馈:")
                            print("=" * 80)
                            ...
                            print("=" * 80)
                            print("✅ Review完成 - Gemini CLI已提供反馈")
                            break
...
if __name__ == "__main__":
    asyncio.run(send_correct_review())
